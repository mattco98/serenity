...
if (NOT COMMAND serenity_lib)
    function(serenity_lib target_name fs_name)
        ...
        compile_with_clang_plugins(${target_name} GENERIC)
...
function(depend_on_clang_plugin target_name plugin_name)
    ...
    target_compile_options(${target_name} PRIVATE -fplugin=${CMAKE_BINARY_DIR}/${CMAKE_INSTALL_LIBDIR}/lib${plugin_name}.so)
endfunction()

function(compile_with_clang_plugins target_name)
    if (ENABLE_CLANG_PLUGINS AND CMAKE_CXX_COMPILER_ID MATCHES "Clang$")
        cmake_parse_arguments(COMPILE_PLUGINS "GENERIC;JS" "" "" ${ARGN})

        if (COMPILE_PLUGINS_GENERIC)
            depend_on_clang_plugin(${target_name} LambdaCaptureClangPlugin)
        endif()
        if (COMPILE_PLUGINS_JS)
            depend_on_clang_plugin(${target_name} LibJSGCClangPlugin)
        endif()
    endif()
endfunction()
