...
[[maybe_unused]] static String title_casify(StringView dashy_name)
{
...
[[maybe_unused]] static String camel_casify(StringView dashy_name)
{
    auto parts = dashy_name.split_view('-');
    StringBuilder builder;
    bool first = true;
...
[[maybe_unused]] static String snake_casify(StringView dashy_name)
{
...
[[maybe_unused]] static ErrorOr<JsonValue> read_entire_file_as_json(StringView filename)
{
