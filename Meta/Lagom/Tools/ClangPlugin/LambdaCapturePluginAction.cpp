...
public:
    ...
    void run(clang::ast_matchers::MatchFinder::MatchResult const& result) override
    {
        ...
        // if (auto const* record = result.Nodes.getNodeAs<clang::CXXRecordDecl>("record")) {
        //     auto diag_id = diag_engine.getCustomDiagID(clang::DiagnosticsEngine::Warning, "foo bar baz");
