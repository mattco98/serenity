...
struct Executable {
    ...
    NonnullOwnPtr<ConstantTable> constant_table;
...
public:
    ...
    ConstantTableIndex intern_string(StringView const& string)
    {
        return m_constant_table->insert(string);
    }
...
private:
    ...
    NonnullOwnPtr<ConstantTable> m_constant_table;
